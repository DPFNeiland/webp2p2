        ...
        <div>
            <div className={styles.div} >
                ...
                <div className={styles.subdiv}>
                    <input type="text" placeholder="Email ou telefone" name="Email_Telefone" id="" className={styles.subdiv}/>
                ...
                <input type="password" name="senha" id="idsenha" placeholder="Confirme sua senha" className={styles.button} />
